  ...
  try {
    ...
    if (clubToShow) {
      document.getElementById(
        "container"
      ).innerHTML = `<header class="bg-white/80 backdrop-blur-sm shadow-sm sticky top-0 z-50 border-b border-gray-200">
        <nav class="flex items-center justify-between px-6 lg:px-16 py-4 max-w-7xl mx-auto">
            <a href="/" class="flex items-center gap-3 cursor-pointer">
                <img src="/assets/la logo.png" alt="logo" width="45" />
                <span class="text-maroon font-bold text-2xl tracking-tighter">LAUConnect</span>
            </a>

            <ul class="hidden lg:flex items-center gap-8 text-maroon font-semibold">
                <li><a href="/" class="hover:text-gold transition-colors duration-300">Home</a></li>
                <li><a href="/clubs.html" class="text-gold font-bold">Clubs</a></li>
                <li><a href="/about.html" class="hover:text-gold transition-colors duration-300">About</a></li>
                <li><a href="/contact.html" class="hover:text-gold transition-colors duration-300">Contact</a></li>
            </ul>

            <div class="lg:hidden">
                <button id="menu-btn" class="text-maroon focus:outline-none">
        ...
        <div id="mobile-menu" class="hidden lg:hidden">
            <ul class="flex flex-col items-center gap-4 py-4 text-maroon font-semibold">
                <li><a href="/" class="hover:text-gold transition-colors duration-300">Home</a></li>
                <li><a href="/clubs.html" class="text-gold font-bold">Clubs</a></li>
                <li><a href="/about.html" class="hover:text-gold transition-colors duration-300">About</a></li>
                <li><a href="/contact.html" class="hover:text-gold transition-colors duration-300">Contact</a></li>
    ...
    <main>
            ...
            <div class="max-w-7xl mx-auto grid lg:grid-cols-2 items-center gap-12 md:gap-16">
                ...
                <div class="space-y-6 text-center lg:text-left">
                    ...
                    <p class="text-base md:text-lg leading-relaxed text-gray-600">
                        Junior Chamber International Nigeria (JCIN) LAUTECH Chapter is a vibrant community of young
                        active citizens dedicated to leadership development and community service.
                    </p>
                    <p class="text-base md:text-lg leading-relaxed text-gray-600">
        ...
        <section class="py-20 md:py-24 bg-off-white text-center px-6">
            <div class="max-w-6xl mx-auto">
                ...
                <p class="text-base md:text-lg text-gray-600 mb-12 md:mb-16 max-w-2xl mx-auto">We focus on three core areas to build
                    well-rounded leaders.</p>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="group p-8 bg-white rounded-2xl shadow-lg shadow-gray-200/50 hover:shadow-xl hover:shadow-maroon/10 border border-gray-100 transform hover:-translate-y-2 transition-all duration-300">
                        ...
                        <h3 class="text-xl md:text-2xl font-semibold text-gold mb-3">Leadership Training</h3>
                        <p class="text-gray-600">We groom students through seminars, workshops, and mentorship programs
                            to become capable leaders.</p>
                    </div>
                    ...
                    <div class="group p-8 bg-white rounded-2xl shadow-lg shadow-gray-200/50 hover:shadow-xl hover:shadow-maroon/10 border border-gray-100 transform hover:-translate-y-2 transition-all duration-300">
                        ...
                        <h3 class="text-xl md:text-2xl font-semibold text-gold mb-3">Community Projects</h3>
                        <p class="text-gray-600">Our members initiate impactful projects that address social challenges
                            and improve lives.</p>
                    </div>
                    ...
                    <div class="group p-8 bg-white rounded-2xl shadow-lg shadow-gray-200/50 hover:shadow-xl hover:shadow-maroon/10 border border-gray-100 transform hover:-translate-y-2 transition-all duration-300">
                        ...
                        <h3 class="text-xl md:text-2xl font-semibold text-gold mb-3">Networking & Growth</h3>
                        <p class="text-gray-600">We connect with global leaders and like-minded changemakers through
                            JCI’s international network.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-20 bg-maroon text-white text-center">
            <div class="max-w-4xl mx-auto px-6">
                <h2 class="text-3xl md:text-4xl font-bold mb-8">Connect With Us</h2>
                <div class="flex flex-wrap justify-center gap-4 md:gap-6">
                    <a href="https://instagram.com/jcinlautech" target="_blank" class="flex items-center gap-3 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-full transition-all duration-300 transform hover:scale-105">
