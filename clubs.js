      ...
      container.innerHTML += `<div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all hover:scale-103">
            ...
            <div class="p-4 relative">
                ...
                <a href="jci.html?club=${club.id}">
                  <button
                      class="inline-block bg-[#800000] sticky bottom-0 text-white px-4 py-2 rounded-lg hover:bg-[#a64b4b] transition cursor-pointer" onclick="learnMore(${club.id})">Learn More
                  </button>
                </a>
